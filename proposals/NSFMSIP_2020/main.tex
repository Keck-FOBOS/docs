...
\noindent \textbf{Targeting modes.} FOBOS deploys a total of 1800 fibers.  Fore-optics on the front end of each fiber demagnify and speed up the beam (from f/15 to f/5) for better
coupling to the fiber numerical aperture and to minimize losses from focal ratio degradation.  The nominal sky sampling
...
Major components of the Preliminary Design effort are described below.
