...
We present FOBOS's primary science goals in the form of three key science ``design-reference'' programs that drive initial requirements and highlight FOBOS's capabilities in addressing the nature of Dark Energy, the formation of galaxies, and the assembly history of the Andromedra Galaxy system.  In the next phase, NSF's OIR Lab, in partnership with the FOBOS team, will solicit additional key program concepts from the U.S. community, host workshops to discuss and refine these concepts, and coordinate proposing teams ahead of a competed selection process to define design-reference programs in support of Preliminary and Final Design.
